...
const DEFAULT_CELL_CLASS = "px-3 md:px-6 py-4 text-sm text-gray-900 h-12"

const DEFAULT_INPUT_CLASS = "w-full px-1 py-1 text-sm text-gray-900 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
